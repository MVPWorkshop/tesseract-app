...
import { RPC_PROVIDER_POLYGON, RPC_PROVIDER_AVAX, PROVIDER_POLLING_INTERVAL } from "../../constants/config.constants";
...
class WalletService {
  ...
  private static _avaxRpcProvider = new JsonRpcProvider(RPC_PROVIDER_AVAX);
